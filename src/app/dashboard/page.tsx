...
const CryptoIcon = ({ coin }: { coin: string }) => {
  const icons: { [key: string]: React.ReactNode } = {
    BTC: (
      ...
      >
        <title>Bitcoin</title>
        <path d="M16.393 12.336c.26-.44.062-.924-.22-1.229l-1.35-1.462a.855.855 0 0 0-.58-.245H12.5V7.077h1.742c.46 0 .832-.373.832-.832V4.492c0-.46-.372-.832-.832-.832H9.758c-.46 0-.832.372-.832.832v1.753c0 .46.372.832.832.832h1.742v2.323h-1.74c-.234 0-.46.09-.623.255L7.804 10.99c-.312.322-.44.77-.31 1.205l1.35 4.34c.22.705.88.94 1.44.94h4.48c.81 0 1.28-.62 1.03-1.4zM12.5 14.834h-1.56l-.8-2.5h3.16zm.8-3.332H10.7l.8-2.5h3.16z" />
      </svg>
    ),
    ETH: (
      <svg
