...
const CryptoIcon = ({ coin }: { coin: string }) => {
  const icons: { [key: string]: React.ReactNode } = {
    BTC: (
      ...
      >
        <title>Bitcoin</title>
        <path d="M11.232 24v-4.226h-2.345V7.323h2.345V3.342c0-1.87.01-3.341 2.302-3.341h2.247v4.183h-2.023v3.139h2.023v12.451h2.345V24zM8.887 14.883v-5.76h6.41v5.76z" />
      </svg>
    ),
    ETH: (
      <svg
